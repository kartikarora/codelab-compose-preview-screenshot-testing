...
package me.kartikarora.jetlagged.ui.composables
...
@Composable
fun JetLaggedDrawer(windowSizeClass: WindowSizeClass) {
...
private fun ScreenContents(
    ...
    val viewModel: JetLaggedScreenViewModel = viewModel()
...
@CombinedPreview
@Composable
private fun JetLaggedDrawerContents(
    @PreviewParameter(ScreenProvider::class) selectedScreen: Screen,
...
enum class Screen(val text: String, val icon: ImageVector) {
    ...
    SleepDetails("Sleep Log", Icons.Default.Bedtime)
}

class ScreenProvider : PreviewParameterProvider<Screen> {
    override val values: Sequence<Screen> = Screen.entries.asSequence()
}
