...
import me.kartikarora.jetlagged.ui.composables.backgrounds.BubbleBackground
import me.kartikarora.jetlagged.ui.composables.backgrounds.FadingCircleBackground
import me.kartikarora.jetlagged.ui.theme.HeadingStyle
...
fun AverageTimeInBedCard(modifier: Modifier = Modifier) {
    TwoLineInfoCard(
        ...
        firstLineText = stringResource(R.string.avg_time_in_bed_heading),
...
fun AverageTimeAsleepCard(modifier: Modifier = Modifier) {
    TwoLineInfoCard(
        ...
        firstLineText = stringResource(R.string.avg_time_sleep_heading),
...
fun WellnessCard(
    ...
    BasicInformationalCard(
        ...
        Column(
            ...
            CardHeading(text = stringResource(R.string.wellness_heading))
            FlowRow(
